...
// Class đại diện cho loại linh kiện
class LoaiLinhKien {
    public $mallinhkien;
    public $tenllinhkien;
    public $soluongban;
...
// Truy vấn SQL để lấy ra số lượng đã bán của mỗi loại linh kiện
$query = "
    SELECT llk.mallinhkien, llk.tenllinhkien, COALESCE(SUM(chd.soluong), 0) AS soluongban
