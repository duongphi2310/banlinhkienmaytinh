...
if(isset($code_order)) {
    $query = "UPDATE hoadon SET trangthai = 5 WHERE MAHD = '$code_order'";

    $result = mysqli_query($connect, $query);
    if($result) {
        echo json_encode(array("message" => "CHUYỂN ĐƠN SANG GIAO THÀNH CÔNG."), JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
    } else {
